...
function addDays(BSdate, days) {
    var d = new Date(BS2AD(BSdate));
    var myDate = new Date(d.getTime() + (days * 24 * 60 * 60 * 1000));
    return myDate;
}
        ...
        function(a) {
            ...
            a.fn.nepaliDatePicker = function(b) { 
                b = "undefined" != typeof b ? b : {}, ndpAttr = b, this.each(function() {
                    ...
                    a(this).addClass("ndp-nepali-calendar"), ndpData[c] = b, ndpAttr.onFocus !== !1 && 
                            a(this).attr("onfocus", "showNdpCalendarBox('" + c + "')"), 
                    ndpAttr.ndpTriggerButton && a(this).after('<button type="button" class="ndp-click-trigger ' + (ndpAttr.ndpTriggerButtonClass ? ndpAttr.ndpTriggerButtonClass : "") 
                            + '" onclick="showNdpCalendarBox(&quot;' + c + '&quot;)">' +
                            (ndpAttr.ndpTriggerButtonText ? ndpAttr.ndpTriggerButtonText : "Pick Date") + "</button>")
...
calendarDivString += '<span id="ndp-target-id" style="display:none"></span>', 
        ...
        calendarDivString += "<th>\u092e\u0902</th>", calendarDivString += "<th>\u092c\u0941</th>", calendarDivString += "<th>\u092c\u093f</th>", calendarDivString += "<th>\u0936\u0941</th>", calendarDivString += "<th>\u0936</th>", calendarDivString += "</tr>", calendarDivString += "</table>",
        calendarDivString += "</div>", calendarDivString += "</div>", arraySum = function(a) {
